========================================================================
    活动模板库 : AniToolbox 项目概况
========================================================================

应用程序向导为您创建了这个 AniToolbox 项目，供您用作
编写动态链接库(DLL)的起点。
...
AniToolbox.idl
    ...
    此文件将由 MIDL 编译器处理以生成:
        C++ 接口定义和 GUID 声明(AniToolbox.h)
        GUID 定义(AniToolbox_i.c)
        类型库(AniToolbox.tlb)
        封送处理代码(AniToolbox_p.c and dlldata.c)

AniToolbox.h
    此文件包含在 AniToolbox.idl 中定义的项的 C++
...
AniToolboxps.vcproj
	...
	dlldata.c、AniToolbox_i.c 和 AniToolbox_p.c，这些是
